...
export const useAdminStats = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      // Get total quizzes count with improved query
      ...
      // If direct count fails, try a different approach for quizzes
      ...
      // Get contact form submissions - should work now with the admin function
      ...
      // Get feedback submissions - should work now with fixed RLS policies
